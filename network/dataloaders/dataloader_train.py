...
class RNA_Dataset_train(Dataset):
    # ACCCCCUUU
    # 000111000
    # ---CCC---
    seqlen_max = 206
    def __init__(self, sequences, reactivtities: list):
...
def setup_dataloader(sequences, reactivities, device: torch.device, **kwargs):

    dataset = RNA_Dataset_train(sequences, reactivities)
